...
API_KEY_GPT = "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"
client = Groq(api_key=API_KEY_GPT)

# Set page configuration
st.set_page_config(page_title="CORE-GPT", page_icon="🤖", layout="centered")
